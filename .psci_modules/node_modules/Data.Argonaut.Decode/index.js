    ...
    return function (json) {
        ...
        if (signature instanceof Data_Generic.SigArray) {
            return Prelude.bind(Data_Either.bindEither)(mFail("Expected an array")(Data_Argonaut_Core.toArray(json)))(function (v) {
                return Prelude["<$>"](Data_Either.functorEither)(Data_Generic.SArray.create)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(function ($72) {
                    return Prelude.map(Data_Either.functorEither)(Prelude["const"])(gDecodeJson$prime(signature.value0(Prelude.unit))($72));
                })(v));
            });
        };
            ...
            return Prelude.bind(Data_Either.bindEither)(mFail(decodingErr("expected an object"))(Data_Argonaut_Core.toObject(json)))(function (v) {
                return Prelude.bind(Data_Either.bindEither)(mFail(decodingErr("'tag' property is missing"))(Data_StrMap.lookup("tag")(v)))(function (v1) {
                    return Prelude.bind(Data_Either.bindEither)(mFail(decodingErr("'tag' property is not a string"))(Data_Argonaut_Core.toString(v1)))(function (v2) {
                        var $45 = Data_Foldable.find(Data_Foldable.foldableArray)(function ($73) {
                            return v2 === (function (v3) {
                        ...
                        throw new Error("Failed pattern match at Data.Argonaut.Decode line 58, column 5 - line 64, column 3: " + [ $45.constructor.name ]);
                    });
                });
            });
        };
...
var gDecodeJson = function (dictGeneric) {
    return function (json) {
        return Control_Bind["=<<"](Data_Either.bindEither)(function ($74) {
            return Data_Maybe.maybe(new Data_Either.Left("fromSpine failed"))(Data_Either.Right.create)(Data_Generic.fromSpine(dictGeneric)($74));
...
var decodeJsonEither = function (dictDecodeJson) {
    return function (dictDecodeJson1) {
        return new DecodeJson(function (j) {
            ...
            var $56 = Data_Argonaut_Core.toObject(j);
            if ($56 instanceof Data_Maybe.Just) {
                return Prelude.bind(Data_Either.bindEither)(just(Data_StrMap.lookup("tag")($56.value0)))(function (v) {
                    return Prelude.bind(Data_Either.bindEither)(just(Data_StrMap.lookup("value")($56.value0)))(function (v1) {
                        var $59 = Data_Argonaut_Core.toString(v);
                        if ($59 instanceof Data_Maybe.Just && $59.value0 === "Right") {
                            return Prelude["<$>"](Data_Either.functorEither)(Data_Either.Right.create)(decodeJson(dictDecodeJson1)(v1));
                        };
                        if ($59 instanceof Data_Maybe.Just && $59.value0 === "Left") {
