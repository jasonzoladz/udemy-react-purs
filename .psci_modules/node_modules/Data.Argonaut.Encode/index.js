...
var encodeJsonChar = new EncodeJson(function ($31) {
    return encodeJson(encodeJsonJString)(Data_String.fromChar($31));
});
    ...
    return function (dictEncodeJson) {
        return function (dictEncodeJson1) {
            return new EncodeJson(function ($32) {
                return encodeJson(encodeJsonList(encodeJsonTuple(dictEncodeJson)(dictEncodeJson1)))(Data_Map.toList($32));
            });
        };
    };
};
...
var gEncodeJson$prime = function (spine) {
    ...
    if (spine instanceof Data_Generic.SArray) {
        return Data_Argonaut_Core.fromArray(Prelude["<$>"](Prelude.functorArray)(function ($33) {
            return gEncodeJson$prime($33(Prelude.unit));
        })(spine.value0));
    };
    if (spine instanceof Data_Generic.SProd) {
        return Data_Argonaut_Core.fromObject(Data_StrMap.insert("tag")(encodeJson(encodeJsonJString)(spine.value0))(Data_StrMap.singleton("values")(encodeJson(encodeJsonArray(encodeJsonJson))(Prelude["<$>"](Prelude.functorArray)(function ($34) {
            return gEncodeJson$prime($34(Prelude.unit));
        })(spine.value1)))));
    };
...
var gEncodeJson = function (dictGeneric) {
    return function ($35) {
        return gEncodeJson$prime(Data_Generic.toSpine(dictGeneric)($35));
    };
};
module.exports = {
